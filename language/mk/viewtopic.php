...
$lang = array_merge($lang, array(
	...
	'BOOKMARK_ADDED'		=> 'Темата е успешно зачувана.',
	'BOOKMARK_ERR'			=> 'Неуспешно зачувување на темата. Ве молиме обидете се повторно.',
	'BOOKMARK_REMOVED'		=> 'Зачуваната тема е успешно отстранета.',
	'BOOKMARK_TOPIC'		=> 'Зачувај ја темата',
	'BOOKMARK_TOPIC_REMOVE'	=> 'Отстрани од зачувани теми',
