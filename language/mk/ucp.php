...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'Со пристапување во „%1$s“ (во понатамошниот текст „ние“, „нас“, „нашето“, „%1$s“, „%2$s“), Вие се согласувате да бидете законски обврзани со следниве услови. Доколку не се согласувате да бидете законски обврзани со следниве услови, Ве молиме не пристапувајте/не го користете „%1$s“. Можеме да ги промениме условите во секое време и во таков случај ќе сториме сè што е можно за да Ве информираме, иако би било разумно редовно да ги прегледувате во Вашето понатамошно користење на „%1$s“. По направените промени, Вие се согласувате да бидете законски обврзани со условите.<br />
	<br />
...
$lang = array_merge($lang, array(
	'ACCOUNT_ACTIVE'				=> 'Вашата сметка е активирана. Ви благодариме за регистрирањето.',
	'ACCOUNT_ACTIVE_ADMIN'			=> 'Сметката е активирана.',
	'ACCOUNT_ACTIVE_PROFILE'		=> 'Вашата сметка е успешно реактивирана.',
	'ACCOUNT_ADDED'					=> 'Ви благодариме за регистрирањето, Вашата сметка е создадена. Можете да се најавите користејќи го Вашето корисничко име и лозинка.',
	'ACCOUNT_COPPA'					=> 'Вашата сметка е создадена, но треба да биде одобрена. Ве молиме проверете ја Вашата имејл адреса за повеќе информации.',
	'ACCOUNT_EMAIL_CHANGED'			=> 'Вашата сметка е обновена, но форумот бара истата да биде реактивирана по промена на имејл адресата. Код за активација е испратен на новата имејл адреса. Ве молиме проверете го Вашиот имејл за повеќе информација.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> 'Вашата сметка е обновена, но форумот бара реактивација на истата од страна на администраторите по промена на имејл адресата. Испратен е имејл до нив и Вие ќе бидете известени при реактивација на сметката.',
	'ACCOUNT_INACTIVE'				=> 'Вашата сметка е создадена, но форумот бара активација. Код за активација е испратен на Вашата имејл адреса. Ве молиме проверете го Вашиот имејл за повеќе информација. Исто така, проверете ја и Вашата папка за непотребна пошта. Може да одземе одредено време за да ја добиете пораката во зависност од Вашиот имејл провајдер.',
	'ACCOUNT_INACTIVE_ADMIN'		=> 'Вашата сметка е создадена, но форумот бара активација од страна на администратор. Испратен е имејл до нив и Вие ќе бидете известени при активација на сметката.',
	'ACTIVATION_EMAIL_SENT'			=> 'Пораката за активација е испратена на Вашата имејл адреса.',
	'ACTIVATION_EMAIL_SENT_ADMIN'	=> 'Пораката за активација е испратена на имејл адресите на администраторите.',
	'ADD'							=> 'Додади',
	'ADD_BCC'						=> 'Додади [BCC]',
	'ADD_FOES'						=> 'Додади нови непријатели',
	'ADD_FOES_EXPLAIN'				=> 'Можете да внесете повеќе кориснички имиња, секое на нов ред.',
	'ADD_FOLDER'					=> 'Додади папка',
	'ADD_FRIENDS'					=> 'Додади нови пријатели',
	'ADD_FRIENDS_EXPLAIN'			=> 'Можете да внесете повеќе кориснички имиња, секое на нов ред.',
	'ADD_NEW_RULE'					=> 'Додади ново правило',
	'ADD_RULE'						=> 'Додади правило',
	'ADD_TO'						=> 'Додади [До]',
	'ADD_USERS_UCP_EXPLAIN'			=> 'Овде можете да додадете нови корисници во групата. Можете да изберете дали групата ќе стане нивната стандардна група. Ве молиме внесете го секое корисничко име на нов ред.',
	'ADMIN_EMAIL'					=> 'Администраторите може да ми испраќаат информација преку имејл',
	'AGREE'							=> 'Се согласувам со условите',
	'ALLOW_PM'						=> 'Дозволете им на корисниците да Ви испраќаат приватни пораки',
	'ALLOW_PM_EXPLAIN'				=> 'Имајте предвид дека администраторите и модераторите секогаш ќе можат да ви испраќаат пораки.',
	'ALREADY_ACTIVATED'				=> 'Вашата сметка веќе е активирана.',
	'ATTACHMENTS_EXPLAIN'			=> 'Ова е листа на датотеки кои сте ги прикачиле во Вашите мислења на форумот.',
	'ATTACHMENTS_DELETED'			=> 'Прикачените датотеки се успешно избришани.',
	'ATTACHMENT_DELETED'			=> 'Прикачената датотека е успешно избришана.',
	'AUTOLOGIN_SESSION_KEYS_DELETED'=> 'Избраните „Запомни ме“ клучеви се успешно избришани.',
	'AVATAR_CATEGORY'				=> 'Категорија',
	'AVATAR_DRIVER_GRAVATAR_TITLE'	=> 'Граватар',
	'AVATAR_DRIVER_GRAVATAR_EXPLAIN'=> 'Граватар е услуга која Ви овозможува да го одржувате Вашиот аватар на повеќе веб-сајтови. Посетете ја <a href="http://www.gravatar.com/">страницата на Граватар</a> за повеќе информација.',
	'AVATAR_DRIVER_LOCAL_TITLE'		=> 'Аватар од галерија',
	'AVATAR_DRIVER_LOCAL_EXPLAIN'	=> 'Можете да го изберете вашиот аватар од локално достапен сет на аватари.',
	'AVATAR_DRIVER_REMOTE_TITLE'	=> 'Аватар од URL адреса',
	'AVATAR_DRIVER_REMOTE_EXPLAIN'	=> 'Линк кон аватари од друг веб-сајт.',
	'AVATAR_DRIVER_UPLOAD_TITLE'	=> 'Прикачи сопствен аватар',
	'AVATAR_DRIVER_UPLOAD_EXPLAIN'	=> 'Прикачете сопствен аватар.',
	'AVATAR_EXPLAIN'				=> 'Максимални димензии; ширина: %1$s, висина: %2$s, големина на датотеката: %3$.2f КиБ.',
	'AVATAR_EXPLAIN_NO_FILESIZE'	=> 'Максимални димензии; ширина: %1$s, висина: %2$s.',
	'AVATAR_FEATURES_DISABLED'		=> 'Аватарите се моментално исклучени.',
	'AVATAR_GALLERY'				=> 'Локална галерија',
	'AVATAR_GENERAL_UPLOAD_ERROR'	=> 'Аватарот не можеше да биде прикачен во %s.',
	'AVATAR_NOT_ALLOWED'			=> 'Вашиот аватар не може да биде прикажан, бидејќи аватарите се исклучени.',
	'AVATAR_PAGE'					=> 'Страница',
	'AVATAR_SELECT'					=> 'Изберете аватар',
	'AVATAR_TYPE'					=> 'Тип на аватар',
	'AVATAR_TYPE_NOT_ALLOWED'		=> 'Вашиот аватар не може да биде прикажан, бидејќи неговиот тип е исклучен.',

	'BACK_TO_DRAFTS'			=> 'Назад кон недовршените мислења',
	'BACK_TO_LOGIN'				=> 'Назад кон страницата за најава',
	'BIRTHDAY'					=> 'Роденден',
	'BIRTHDAY_EXPLAIN'			=> 'Со наведуање на година Вашата возраст ќе биде прикажана на Вашиот роденден.',
	'BOARD_DATE_FORMAT'			=> 'Формат за датум',
	'BOARD_DATE_FORMAT_EXPLAIN'	=> 'Користената ситакса е идетична со PHP функцијата <a href="http://www.php.net/date">date()</a>.',
	'BOARD_LANGUAGE'			=> 'Мојот јазик',
	'BOARD_STYLE'				=> 'Мојот стил на форумот',
	'BOARD_TIMEZONE'			=> 'Мојата временска зона',
	'BOOKMARKS'					=> 'Зачувани теми',
	'BOOKMARKS_EXPLAIN'			=> 'Можете да зачувувате теми за полесно пронаоѓање. Изберете го полето за секоја зачувана тема која сакате да ја избришете и протиснете на копчето <em>Острани ги обележаните зачувани теми</em>.',
	'BOOKMARKS_DISABLED'		=> 'Зачуваните теми се исклучени на овој форум.',
	'BOOKMARKS_REMOVED'			=> 'Зачуваната тема е успешно отстранета.',

	'CANNOT_EDIT_MESSAGE_TIME'	=> 'Веќе не можете да ја променувате или избришете пораката.',
	'CANNOT_MOVE_TO_SAME_FOLDER'=> 'Пораките не може да бидат преместени во форумот кој сакате да го отстраните.',
	'CANNOT_MOVE_FROM_SPECIAL'	=> 'Пораките не може да бидат извадени од излезното сандаче.',
	'CANNOT_RENAME_FOLDER'		=> 'Оваа папка не може да биде преименувана.',
	'CANNOT_REMOVE_FOLDER'		=> 'Оваа папка не може да биде отстранета.',
	'CHANGE_DEFAULT_GROUP'		=> 'Промени стандардна група',
	'CHANGE_PASSWORD'			=> 'Промени лозинка',
	'CLICK_GOTO_FOLDER'			=> '%1$sОди во папката „%3$s“%2$s',
	'CLICK_RETURN_FOLDER'		=> '%1$sНазад кон папката „%3$s“%2$s',
	'CONFIRMATION'				=> 'Потврда за регистрација',
	'CONFIRM_CHANGES'			=> 'Потврди ги промените',
	'CONFIRM_EXPLAIN'			=> 'Со цел да спречиме автоматски регистрации, форумот бара да внесете код за потврда. Кодот е прикажан на сликата која би требало да ја видите подоле. Ако поради оштетување на видот или некоја друга причина не можете да го прочитате кодот, Ве молиме контактирајте со %sадминистраторот на форумот%s.',
	'VC_REFRESH'				=> 'Обнови го кодот за потврда',
	'VC_REFRESH_EXPLAIN'		=> 'Доколку не можете да го прочитате кодот, можете да побарате нов со притискање на копчето.',

	'CONFIRM_PASSWORD'			=> 'Потврди ја лозинката',
	'CONFIRM_PASSWORD_EXPLAIN'	=> 'Треба да ја потврдите лозинката само доколку сте ја промениле погоре.',
	'COPPA_BIRTHDAY'			=> 'За да продолжите со процедурата за регистрација, Ве молиме наведете кога сте родени.',
	'COPPA_COMPLIANCE'			=> 'COPPA усогласување',
	'COPPA_EXPLAIN'				=> 'Имајте во предвид дека со притискање на копчето Вашата сметка ќе биде создадена. Но, истата не може да биде активирана пред да биде одобрена од родител или старател. Ќе ви биде испратена копија преку имејл која го содржи потребниот формулар со податоци каде треба да се испрати.',
	'CREATE_FOLDER'				=> 'Додади папка…',
	'CURRENT_IMAGE'				=> 'Тековна слика',
	'CURRENT_PASSWORD'			=> 'Тековна лозинка',
	'CURRENT_PASSWORD_EXPLAIN'	=> 'Мора да ја внесете Вашата тековна лозинка доколку сакате да ја промените имејл адресата или корисничкото име.',
	'CURRENT_CHANGE_PASSWORD_EXPLAIN' => 'За да ја промените лозинката, имејл адресата или корисничкото име, треба да ја внесете Вашата тековна лозинка.',
	'CUR_PASSWORD_EMPTY'		=> 'Не ја внесовте Вашата тековна лозинка.',
	'CUR_PASSWORD_ERROR'		=> 'Внесената тековна лозинка е погрешна.',
	'CUSTOM_DATEFORMAT'			=> 'Прилагодена…',

	'DEFAULT_ACTION'			=> 'Стандардно дејство',
	'DEFAULT_ACTION_EXPLAIN'	=> 'Ова дејство ќе биде применето ако ниту едно од горенаведените не е достапно.',
	'DEFAULT_ADD_SIG'			=> 'Автоматски прикачувај го мојот потпис',
	'DEFAULT_BBCODE'			=> 'Автоматски вклучувај BBCode',
	'DEFAULT_NOTIFY'			=> 'Автоматски вклучувај го известувањето за нови одговори',
	'DEFAULT_SMILIES'			=> 'Автоматски вклучувај ги емотиконите',
	'DEFINED_RULES'				=> 'Дефинирани правила',
	'DELETED_TOPIC'				=> 'Темата е отстранета.',
	'DELETE_ATTACHMENT'			=> 'Избриши ја прикачена датотека',
	'DELETE_ATTACHMENTS'		=> 'Избриши ги прикачените датотеки',
	'DELETE_ATTACHMENT_CONFIRM'	=> 'Сигурни ли сте дека сакате да ја избришете избраната прикачена датотека?',
	'DELETE_ATTACHMENTS_CONFIRM'=> 'Сигурни ли сте дека сакате да ги избришете избраните прикачени датотеки?',
	'DELETE_AVATAR'				=> 'Избриши ја сликата',
	'DELETE_COOKIES_CONFIRM'	=> 'Сигурни ли сте дека сакате да ги избришете сите колачиња поставени од овој форум?',
	'DELETE_MARKED_PM'			=> 'Избриши ги обележаните пораки',
	'DELETE_MARKED_PM_CONFIRM'	=> 'Сигурни ли сте дека сакате да ги избришете сите обележани пораки?',
	'DELETE_OLDEST_MESSAGES'	=> 'Избриши ги најстарите пораки',
	'DELETE_MESSAGE'			=> 'Избриши ја пораката',
	'DELETE_MESSAGE_CONFIRM'	=> 'Сигурни ли сте дека сакате да ја избришете приватната порака?',
	'DELETE_MESSAGES_IN_FOLDER'	=> 'Избриши ги сите пораки во отстранетата папка',
	'DELETE_RULE'				=> 'Избриши го правилото',
	'DELETE_RULE_CONFIRM'		=> 'Сигурни ли сте дека сакате да го избришете правилото?',
	'DEMOTE_SELECTED'			=> 'Деградидај ги избраните',
	'DISABLE_CENSORS'			=> 'Активирај го цензурирањето на зборови',
	'DISPLAY_GALLERY'			=> 'Прикажи ја галеријата',
	'DOMAIN_NO_MX_RECORD_EMAIL'	=> 'Внесениот имејл домен нема валиден MX запис.',
	'DOWNLOADS'					=> 'Преземања',
	'DRAFTS_DELETED'			=> 'Избраните недовршени мислења се успешно избришани.',
	'DRAFTS_EXPLAIN'			=> 'Овде можете да ги прегледате, промените и избришете Вашите недовршени мислења.',
	'DRAFT_UPDATED'				=> 'Недовршеното мислење е успешно обновено.',
