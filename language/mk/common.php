...
$lang = array_merge($lang, array(
	...
	'ATTACHED_IMAGE_NOT_IMAGE'		=> 'Сликовата датотека која се обидовте да ја прикачите е невалидна.',
	'AUTHOR'						=> 'Автор',
	...
	'AVATAR_PHP_SIZE_NA'			=> 'Големината на датотеката за профилната слика е премногу голема.<br />Максималната дозволена големина поставена во php.ini не може да биде одредена.',
	'AVATAR_PHP_SIZE_OVERRUN'		=> 'Големината на датотеката за профилната слика е премногу голема. Максималната дозволена големина е %1$d %2$s.<br />Имајте во предвид дека ова е поставено во php.ini и не може да биде преовладано.',
