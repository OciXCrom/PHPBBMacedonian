...
$lang = array_merge($lang, array(
	...
	'ACP_SHORT'						=> 'АКП',
	'ACTIVE'						=> 'активен',
	'ACTIVE_ERROR'					=> 'Наведеното корисничко име е моментално неактивно. Доколку имате потешкотии со активирањето на Вашата сметка, Ве молиме контактирајте со администратор на сајтот.',
	...
	'AVATAR_URL_INVALID'			=> 'Посочената УРЛ адреса е невалидна.',
